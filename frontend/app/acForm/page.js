...
const ACForm = ({ onSubmit }) => {
    ...
    useEffect(() => {
        const fetchACPercentage = async () => {
            try {
                const response = await axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/${selectedSection}`);
    ...
    const handleSubmit = async (e) => {
        ...
        if (selectedSection && acPercentage !== '') {
            try {
                await axios.patch(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/ac/${selectedSection}`, {
