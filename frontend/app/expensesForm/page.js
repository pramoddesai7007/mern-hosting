...
const ExpenseFormList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const expenseResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expense/expenses');
        setExpenses(expenseResponse.data);

        const bankResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/bankName/bankNames');
  ...
  const fetchDataForTable = async () => {
    try {
      const tableResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expensesForm');
  ...
  const handleEditSubmit = async () => {
    try {
      const response = await axios.patch(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expensesForm/${editExpense._id}`,
        {
          date: expenseDate,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expensesForm', {
        date: expenseDate,
        expenseType: selectedExpense,
        description: description,
        paidBy: paidBy,
  ...
  const handleDeleteConfirm = async () => {
    try {
      await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expensesForm/${deleteExpense._id}`);
