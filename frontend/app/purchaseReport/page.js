...
const PurchaseReport = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const purchasesResponse = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/purchase/purchases");
        setPurchases(purchasesResponse.data);
        setFilteredPurchases(purchasesResponse.data);

        const itemsResponse = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items");
        setItems(itemsResponse.data);

        const vendorsResponse = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers");
