...
//       try {
//         const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units');
...
//       await axios.patch(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units/${selectedUnit._id}`, {
...
//     try {
//       await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units/${selectedUnit._id}`);
...
//       await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units', { unit: newUnit });
...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      const response = await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/auth/login', { username, password });
