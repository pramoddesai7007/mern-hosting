...
const CreateHotelForm = () => {
  ...
  const fetchHotels = async () => {
    try {
      const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/get-all');
  ...
  const handleEdit = async (hotelId) => {
    try {
      const response = await axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/get/${hotelId}`);
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/edit/${editFormData._id}`, formDataForUpload);
  ...
  const handleDelete = async (hotelId) => {
    try {
      await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/delete/${hotelId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/create', formDataForUpload);
