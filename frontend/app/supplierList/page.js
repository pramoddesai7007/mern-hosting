...
const SupplierList = () => {
    ...
    useEffect(() => {
        const fetchSuppliers = async () => {
            try {
                const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers');
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers/${editedSupplier._id}`,
                editedSupplier
            );
    ...
    const handleDeleteConfirmed = async () => {
        try {
            ...
            await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers/${editedSupplier._id}`);
