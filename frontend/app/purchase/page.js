...
const PurchaseForm = () => {
    ...
    const fetchStockQty = async () => {
      try {
        const response = await axios.get(
          `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/purchase/purchase/stockQty?itemName=${formData.itemName}`
        );
  ...
  useEffect(() => {
    const fetchVendors = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers"
        );
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items"
        );
  ...
  useEffect(() => {
    const fetchGSTList = async () => {
      try {
        const response = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/gst/list");
  ...
  useEffect(() => {
    const fetchUnitList = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units"
        );
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await axios.post(
        "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/purchase/purchase/savebill",
        data
      );
      ...
      if (parseFloat(data.total) > 0) {
        ...
        await axios.post("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/supplier/debit", {
          vendorName,
          amount: parseFloat(data.paidAmount),
        });
      } else {
        // If there is no paid amount, update the supplier's credit balance
        await axios.post("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/supplier/credit", {
          vendorName,
