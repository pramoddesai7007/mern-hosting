...
const SupplierPayment = () => {
    ...
    useEffect(() => {
        axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers')
    ...
    useEffect(() => {
        if (selectedSupplier) {
            axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/suppliers/${selectedSupplier}`)
                .then(response => {
    ...
    const handleDebitSubmission = (e) => {
        ...
        if (debitAmount <= creditBalance && !loading) {
            ...
            axios.put(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/supplier/updateBalance/${selectedSupplier}`, {
                debit: debitAmount,
            })
                .then(response => {
