...
const ExpenseList = () => {
  ...
  useEffect(() => {
    const fetchExpenses = async () => {
      try {
        const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expense/expenses');
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.patch(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expense/expenses/${selectedExpense._id}`, {
  ...
  const handleDeleteSubmit = async () => {
    try {
      await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expense/expenses/${selectedExpense._id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/expense/expenses', { expense: newExpense });
