...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  const handleDebitSubmission = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/customer/updateBalance/${selectedCustomer}`,
        {
          debit: debitAmount,
        }
      );
      ...
      const recordsResponse = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/customer/customers/${selectedCustomer}`
      );
  ...
  const handleDeleteRecord = async (recordId, debitAmount) => {
    try {
      ...
      await axios.delete(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
      );
