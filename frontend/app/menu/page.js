...
const EditModal = ({ isOpen, onCancel, onEdit, menuToEdit }) => {
    ...
    useEffect(() => {
        ...
        if (menuToEdit) {
            setExistingImage(
                menuToEdit.imageUrl
                    ? `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${menuToEdit.imageUrl}`
                    : null
            );
    ...
    const handleEdit = async () => {
        try {
            ...
            const response = await axios.patch(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menus/${menuToEdit._id}`,
                formData
            );
...
const MenuList = () => {
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menus/${menuToDelete._id}`
            );
    ...
    const addNewMenu = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menu",
                formData
            );
        ...
        const fetchMenus = async () => {
            try {
                const response = await axios.get(
                    "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menus/list"
                );
    ...
    const handleFileUpload = async () => {
        try {
            ...
            const response = await axios.post(
                "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/upload-excel",
                formData
            );
        ...
        .map((menu, index) => (
            ...
            >
                ...
                <td className="text-left pl-8">
                    {menu.imageUrl ? (
                        <img
                            src={`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${menu.imageUrl}`}
                            width={50}
                            height={50}
                            alt="Menu Image"
                    ...
                    <div className="modal-container bg-white w-96 p-8 rounded-md shadow-lg m-1">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-4">
                                ...
                                {menuToView?.imageUrl ? (
                                    <img
                                        src={`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${menuToView.imageUrl}`}
                                        alt="Menu"
