...
const capitalizeFirstLetter = (str) => {
    ...
    if (name === "unit") {
      ...
      try {
        const unitDetailsResponse = await axios.get(
          `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/unit/units/${value}`
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (itemToEdit) {
        ...
        await axios.put(
          `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items/${itemToEdit._id}`,
          formData
        );
      } else {
        // If creating, make a POST request
        await axios.post("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items", {
          ...formData,
  ...
  const handleDeleteConfirmed = async () => {
    try {
      ...
      await axios.delete(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items/${itemIdToDelete}`
      );
  ...
  //     await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items/${itemId}`);
