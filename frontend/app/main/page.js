...
const MainMenuList = () => {
  ...
  const handleViewMainCategory = async (mainCategory) => {
    try {
      const response = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main/${mainCategory._id}`
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main",
        formData,
        {
          headers: {
  ...
  const handleDeleteConfirmed = async (menu) => {
    try {
      ...
      const response = await axios.delete(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main/${menu._id}`
      );
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      const response = await axios.patch(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main/${editedMenu._id}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
      ...
      const updatedMenusResponse = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main");
  ...
  const handlePicturePreview = (mainImage) => {
    const completeImageUrl = `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${mainImage}`;
  ...
  useEffect(() => {
    const fetchMenus = async () => {
      try {
        const response = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main");
              ...
              <div className="p-1 text-center">
                ...
                <p>
                  ...
                  {mainCategoryToView?.mainImage ? (
                    <img
                      src={`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${mainCategoryToView.mainImage}`}
                      alt="Main Category"
