    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/counts');
                setCounts(response.data);

                // Fetch data for temporary orders count
                const temporaryOrdersResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/temporary-orders-count');
                ...
                const totalForCurrentDateResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/total-amount-for-current-date');
                setCounts(prevCounts => ({
                    ...prevCounts,
                ...
                const totalForPreviousMonthResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/total-amount-for-previous-month');
                setCounts(prevCounts => ({
                    ...prevCounts,
                    totalForPreviousMonth: totalForPreviousMonthResponse.data.totalForPreviousMonth,
                }));

                const totalBalanceResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/purchase/purchases-total');
                setCounts(prevCounts => ({
                    ...prevCounts,
