...
const Tables = () => {
    ...
    const handleView = async (tableId) => {
        try {
            const response = await axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${tableId}`);
    ...
    const handleEditSubmit = async () => {
        try {
            ...
            const response = await axios.patch(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${editTable._id}`,
                formData,
                {
                    headers: {
    ...
    useEffect(() => {
        const fetchTables = async () => {
            try {
                const tablesResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables');
        ...
        const fetchSections = async () => {
            try {
                const sectionsResponse = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section');
    ...
    const handleAddSubmit = async () => {
        try {
            ...
            const response = await axios.post(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/${sectionId}/tables`,
                formData,
                {
                    headers: {
                        "Content-Type": "application/json",
    ...
    useEffect(() => {
        const fetchtables = async () => {
            try {
                const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables');
    ...
    const confirmDelete = async () => {
        try {
            ...
            const response = await axios.delete(
                `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${tableToDelete._id}`
            );
