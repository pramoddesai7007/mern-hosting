...
const GroupMenu = () => {
  ...
  const handleAddMenusToCategory = async () => {
    try {
      ...
      const response = await axios.post(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/${selectedMainCategory}/assignmenus`,
        {
  ...
  const fetchMenusForCategory = async () => {
    try {
      const response = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main/${selectedMainCategory}`
      );
  ...
  const handleDeleteMenus = async () => {
    try {
      ...
      const response = await axios.delete(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/${selectedMainCategory}/removemenus`,
        {
