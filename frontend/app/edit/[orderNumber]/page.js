...
const EditOrderPage = ({ params, tableId }) => {
      ...
      try {
        if (orderNumber) {
          ...
          const orderResponse = await axios.get(
            `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/get/order/${orderNumber}`
          );
          ...
          const sectionResponse = await axios.get(
            `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/sectionlist/${tableId}`
          );
  ...
  const handleSaveBill = async () => {
    try {
      ...
      await axios.post(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/logHistory/log-history`, {
      ...
      const updateOrderEndpoint = `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/update-order-by-number/${orderNumber}`;
  ...
  const handlePrintBill = async () => {
    try {
      ...
      const tableResponse = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${tableId}`
      );
