...
const StockOutwardForm = () => {
    ...
    const handleAddItems = async () => {
        try {
            ...
            await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/stockOut/stockOut/addItems', {
                waiterName,
                productName,
                stockQty,
                availableQuantity
            ...
            await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items/updateQuantity', {
                productName,
                stockQty,
            });
    ...
    const handleInputChange = async (e) => {
        ...
        try {
            if (name === 'waiterName') {
                setWaiterName(value);
                const response = await axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/waiter/waiter/mobile?name=${value}`);
                setMobileNumber(response.data.mobileNumber);
            } else if (name === 'productName') {
                setProductName(value);
                const response = await axios.get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items/quantity?productName=${value}`);
    ...
    const fetchProductNames = async () => {
        try {
            const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/item/items');
    ...
    const fetchStockOutwardList = async () => {
        try {
            const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/stockOut/stockOut');
