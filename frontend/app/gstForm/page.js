...
const GSTForm = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      ...
      await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/gst/gst/${deletingItemId}`);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/gst/create', { gstPercentage });
      fetchGSTList();
      setGSTPercentage('');
    } catch (error) {
