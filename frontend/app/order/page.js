...
const Billing = ({ tableId, acPercentage }) => {
    ...
    const fetchTastes = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/taste/tastes"
        );
  ...
  const fetchWaitersList = async () => {
    try {
      const response = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/waiter");
  ...
  useEffect(() => {
    const fetchGreetings = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/greet/greet"
        );
  ...
  useEffect(() => {
    ...
    const fetchNextOrderNumber = async () => {
      try {
        const response = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/get-next-order-number"
        );
  ...
  const fetchLastAllOrders = async () => {
    try {
      const ordersResponse = await axios.get(
        "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/latest-orders"
      );
      ...
      const tableNamesPromises = orders.map(async (order) => {
        const tableResponse = await axios.get(
          `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${order.tableId}`
        );
  ...
  const saveBill = async () => {
    try {
      ...
      const existingBillResponse = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/order/${tableId}`
      );
      ...
      if (existingBill && existingBill.length > 0) {
        ...
        const updateResponse = await axios.patch(
          `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/update-order-by-id/${orderIdToUpdate}`,
          orderData
        );
      ...
      const KOTResponse = await axios.post(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/kot/kotOrder/${tableId}`,
        kotData
      );
  ...
  const saveKot = async () => {
    try {
      ...
      const existingKOTResponse = await axios.get(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/kot/kot/${tableId}`
      );
...
<p style="${!hotelInfo || !hotelInfo.sacNo ? "display: none;" : ""}">SAC No: ${hotelInfo ? hotelInfo.sacNo : "SAC No Not Found"
  ...
  useEffect(() => {
    ...
    // Fetch categories
    axios
      .get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/main")
      .then((response) => {
    ...
    // Fetch products
    axios
      .get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menus/list")
      .then((response) => {
        console.log(response.data);
    ...
    if (tableId) {
      axios
        .get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables/${tableId}`)
        .then((response) => {
  ...
  useEffect(() => {
    ...
    if (selectedCategory) {
      axios
        .get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/${selectedCategory._id}`)
        .then((response) => {
          console.log(response.data);
          const menusArray = response.data || []; // Ensure menus is an array
          setMenus(menusArray);
  ...
  const handleCategoryClick = (category) => {
    ...
    if (category === null) {
      ...
      // Fetch menus based on the selected category
      axios
        .get(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/menu/menulist/${category._id}`)
        .then((response) => {
          setMenus(response.data);
        })
        .catch((error) => {
    ...
    const fetchHotelInfo = async () => {
      try {
        ...
        const allHotelsResponse = await axios.get(
          "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/get-all"
        );
        ...
        if (defaultHotelId) {
          ...
          const response = await axios.get(
            `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/hotel/get/${defaultHotelId}`
          );
                ...
                <div key={orderItem._id} className="flex items-center mb-3">
                  <div className="flex flex-row items-center ">
                    <div className="flex items-center h-full">
                      <img
                        // src={`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/${orderItem.imageUrl}`}
                        src={`/tray.png`}
