...
const Greetings = () => {
  ...
  const getGreetings = async () => {
    try {
      const response = await axios.get('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/greet/greet');
  ...
  const deleteGreet = async (greetId) => {
    try {
      const response = await axios.delete(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/greet/greet/${greetId}`);
  ...
  const createGreet = async () => {
    ...
    try {
      const response = await axios.post('http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/greet/greet', createGreetData);
  ...
  const updateGreet = async (greetId) => {
    ...
    try {
      const response = await axios.patch(`http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/greet/greet/${greetId}`, updateGreetData);
