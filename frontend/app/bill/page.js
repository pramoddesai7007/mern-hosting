...
//     };
//   }, [inputTableNumber]); // Empty dependency array ensures this runs only once on mount
...
//           "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/table/tables"
//         );
...
//               `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/order/order/${table._id}`
//             );
...
//             // className="sr-only" // Hide the input field visually
//             />
//           {/* <button onClick={handleOpenTable} className="p-2 bg-blue-500 text-white rounded">
//             Open Table
//           </button> */}
//         </div>
