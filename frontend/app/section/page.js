...
const Section = () => {
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        const response = await axios.get("http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section");
  ...
  const handleEditSubmit = async () => {
    ...
    try {
      ...
      await axios.patch(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/${sectionToEdit._id}`,
        {
  ...
  const handleDeleteConfirmed = async () => {
    ...
    try {
      await axios.delete(
        `http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/${sectionToDelete._id}`
      );
      ...
      const sectionsResponse = await axios.get(
        "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section"
      );
  ...
  const handleAddSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "http://ec2-15-206-189-233.ap-south-1.compute.amazonaws.com:5000/api/section/create",
        formData,
        {
          headers: {
